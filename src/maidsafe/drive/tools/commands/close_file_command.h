...
class CloseFileCommand {
 public:
  explicit CloseFileCommand(Environment& environment) : environment_(environment) {}
  void Run();
  static const Operation kTypeId = Operation::kCloseFile;
...
#endif  // MAIDSAFE_DRIVE_TOOLS_COMMANDS_CLOSE_FILE_COMMAND_H_
