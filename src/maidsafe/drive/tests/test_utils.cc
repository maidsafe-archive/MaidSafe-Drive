...
void GenerateDirectoryListingEntryForFile(std::shared_ptr<Directory> directory,
  ...
  File file(path.filename(), false);
#ifdef MAIDSAFE_WIN32
  file.meta_data.end_of_file = file_size;
  ...
  file.meta_data.attributes.st_size = file_size;
#endif
  file.meta_data.data_map->content = RandomString(100);
